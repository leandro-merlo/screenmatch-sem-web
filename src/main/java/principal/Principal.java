...
public class Principal {
    ...
    private DadosEpisodioAvaliacaoComparator comparator = new DadosEpisodioAvaliacaoComparator();
    ...
    private DadosSerie getDadosSerie() {
        ...
        var json = consumoAPI.obterDados("search/tv?query=%s&language=pt-BR".formatted(serie));
        ...
        if (tempDadosSeries.size() > 1) {
            ...
            var dadosSerie = consumoAPI.obterDados("tv/%s?language=pt-BR".formatted(id));
            var dadosAtores = consumoAPI.obterDados("tv/%s/credits?language=pt-BR".formatted(id));
            ...
            var dadosSerie = consumoAPI.obterDados("tv/%s?language=pt-BR".formatted(tempDadosSeries.get(0).id()));
